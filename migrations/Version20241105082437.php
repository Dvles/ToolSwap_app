 ...
 */
final class Version20241105082437 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tool_availability (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tool_id INT NOT NULL, borrow_tool_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, start DATE NOT NULL, end DATE NOT NULL, description LONGTEXT DEFAULT NULL, background_color VARCHAR(255) NOT NULL, border_color VARCHAR(255) NOT NULL, text_color VARCHAR(255) NOT NULL, is_available TINYINT(1) NOT NULL, INDEX IDX_B3FEEC52A76ED395 (user_id), INDEX IDX_B3FEEC528F7B22CC (tool_id), INDEX IDX_B3FEEC52D18B2448 (borrow_tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
