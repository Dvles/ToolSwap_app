 ...
 */
final class Version20250210184948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tool (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, tool_category_id INT NOT NULL, name VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, tool_condition VARCHAR(20) NOT NULL, availability TINYINT(1) DEFAULT NULL, is_disabled TINYINT(1) NOT NULL, price_day NUMERIC(5, 2) DEFAULT NULL, image_tool VARCHAR(255) NOT NULL, INDEX IDX_20F33ED17E3C61F9 (owner_id), INDEX IDX_20F33ED1887483BC (tool_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tool_availability (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tool_id INT NOT NULL, borrow_tool_id INT DEFAULT NULL, start DATE NOT NULL, end DATE NOT NULL, description LONGTEXT DEFAULT NULL, background_color VARCHAR(255) NOT NULL, border_color VARCHAR(255) NOT NULL, text_color VARCHAR(255) NOT NULL, is_available TINYINT(1) NOT NULL, INDEX IDX_B3FEEC52A76ED395 (user_id), INDEX IDX_B3FEEC528F7B22CC (tool_id), INDEX IDX_B3FEEC52D18B2448 (borrow_tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tool_availability ADD CONSTRAINT FK_B3FEEC52D18B2448 FOREIGN KEY (borrow_tool_id) REFERENCES borrow_tool (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tool_availability DROP FOREIGN KEY FK_B3FEEC52D18B2448');
