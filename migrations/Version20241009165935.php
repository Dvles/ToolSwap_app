 ...
 */
final class Version20241009165935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE borrow_tool (id INT AUTO_INCREMENT NOT NULL, user_borrower_id INT NOT NULL, tool_being_borrowed_id INT NOT NULL, tool_availability_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_A3DE04F4B8D5F8BE (user_borrower_id), INDEX IDX_A3DE04F42F823257 (tool_being_borrowed_id), INDEX IDX_A3DE04F4A1B75CA6 (tool_availability_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tool_availability (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tool_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, start DATE NOT NULL, end DATE NOT NULL, description LONGTEXT DEFAULT NULL, background_color VARCHAR(255) NOT NULL, border_color VARCHAR(255) NOT NULL, text_color VARCHAR(255) NOT NULL, is_available TINYINT(1) NOT NULL, INDEX IDX_B3FEEC52A76ED395 (user_id), INDEX IDX_B3FEEC528F7B22CC (tool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE borrow_tool ADD CONSTRAINT FK_A3DE04F4A1B75CA6 FOREIGN KEY (tool_availability_id) REFERENCES tool_availability (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE borrow_tool DROP FOREIGN KEY FK_A3DE04F4A1B75CA6');
